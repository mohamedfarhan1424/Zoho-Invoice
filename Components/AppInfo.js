              ...
              <div className={styles.icons}>
                <div className="d-flex">
                  <div className={styles.icon}>
                    <a href="https://play.google.com/store/apps/details?id=com.zoho.invoice&referrer=utm_source%3Dwebsite%26utm_medium%3Dhomepage"><Image src={Playstore} alt="PlayStore" /></a>
                  </div>
                  <div className={styles.icon}>
                    <a href="https://apps.apple.com/app/apple-store/id413017364?mt=8"><Image src={Apple} alt="Apple" /></a>
                  </div>
                  <div className={styles.icon}>
                    <a href="https://www.microsoft.com/en-us/p/zoho-invoice/9wzdncrdfd1h?cid=ZohoInvoiceWeb&rtc=1"><Image src={Microsoft} alt="Microsoft" /></a>
                  </div>
                </div>
